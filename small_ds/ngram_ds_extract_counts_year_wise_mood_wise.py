...
def split_data_by_word_test_case():
    split_data_by_word("abcd", "", ["one two seven six group1 1995 2 5", "one two three four mixed 1995 2 5",
                                    "one two three not mixed 1995 2 5", "ten nine five six nutral 1998 2 5"], 0, 0)
